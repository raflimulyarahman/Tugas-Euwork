            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-3 col-md-6 mb-4">
                        ...
                        <p>Platform e-commerce terpercaya dengan ribuan produk berkualitas dan pelayanan terbaik.</p>
                    </div>
                    <div class="col-lg-3 col-md-6 mb-4">
                        <h5 class="mb-3">Layanan</h5>
                        <ul class="list-unstyled">
                            <li><a href="#" class="text-light">Bantuan</a></li>
                            <li><a href="#" class="text-light">Cara Belanja</a></li>
                            <li><a href="#" class="text-light">Pengiriman</a></li>
                            <li><a href="#" class="text-light">Pengembalian</a></li>
                        </ul>
                    </div>
                    <div class="col-lg-3 col-md-6 mb-4">
                    ...
                    <div class="col-lg-3 col-md-6 mb-4">
                        ...
                        <p><i class="fas fa-map-marker-alt me-2"></i>Jl. Sudirman No. 123, Jakarta</p>
                        <p><i class="fas fa-phone me-2"></i>+62 21 1234 5678</p>
                        <p><i class="fas fa-envelope me-2"></i>info@shopmart.com</p>
                    </div>
                </div>
                <hr class="my-4">
                <div class="text-center">
                    <p>&copy; 2025 ShopMart. Semua hak dilindungi.</p>
                </div>
            </div>
        </footer>
